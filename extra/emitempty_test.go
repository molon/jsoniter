...
func TestEmitEmptyExtension(t *testing.T) {
	...
	cfg = jsoniter.Config{}.Froze()
	cfg.RegisterExtension(&EmitEmptyWithTypeExtension{})
	...
	cfg = jsoniter.Config{}.Froze()
	cfg.RegisterExtension(&EmitEmptyWithTypeExtension{Filter: func(typ reflect2.Type) bool {
	...
	cfg = jsoniter.Config{}.Froze()
	cfg.RegisterExtension(&EmitEmptyWithBindingExtension{})
	...
	cfg = jsoniter.Config{}.Froze()
	cfg.RegisterExtension(&EmitEmptyWithBindingExtension{Filter: func(binding *jsoniter.Binding) bool {
